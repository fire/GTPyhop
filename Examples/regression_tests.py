...
simple_htn.main(False)
import simple_hgn

simple_hgn.main(False)
import backtracking_htn

backtracking_htn.main(False)
import logistics_hgn

logistics_hgn.main(False)
import blocks_gtn

blocks_gtn.main(False)
import blocks_goal_splitting

blocks_goal_splitting.main(False)
import blocks_hgn

blocks_hgn.main(False)
import blocks_htn
