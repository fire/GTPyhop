...
def main(do_pauses=True):
    ...
    print(
        "Next are some example problems with verbose=3 in order to see the backtracking.\n"
    )
    gtpyhop.verbose = 3
    th.pause(do_pauses)

    print(
        """Below, seek_plan backtracks once to use a different method for 'put_it'.
"""
    )
...
"""
    ...
    print(
        """Below, seek_plan backtracks to use a different method for 'put_it',
